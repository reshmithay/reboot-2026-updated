...
const ClientProfilePage: React.FC = () => {
  ...
  const pieChartData = [
    {
      name: "Critical",
      value: riskDistributionData.critical,
      color: "#DC2626",
    },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="mt-4 text-sm text-gray-600">
            Connect all addresses and transactions to a single entity. Build a
            clear <span className="font-medium">risk profile</span> to support
            enhanced due diligence and confident decisions.
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Risk Engine Chart — hidden, coming soon */}
            ...
            <InfoCard title="Triggered Risk Engine">
              <div className="flex flex-col items-center justify-center py-10 text-center">
                ...
                <p className="text-gray-400 text-xs max-w-[180px]">
                  Risk engine triggers will display here once integrated.
                </p>
              </div>
            </InfoCard>
          </div>

          {/* Risk Distribution Pie Chart — hidden, coming soon */}
          <div className="lg:col-span-1 hidden">
          ...
          {/* Risk Distribution — Coming Soon card */}
          <div className="lg:col-span-1">
            <InfoCard title="Risk Distribution">
              <div className="flex flex-col items-center justify-center py-10 text-center">
                ...
                <p className="text-gray-400 text-xs max-w-[180px]">
                  Risk breakdown by severity will appear here once data is
                  available.
                </p>
              </div>
            </InfoCard>
                ...
                {recentAlerts.length === 0 ? (
                  ...
                  recentAlerts.map((alert) => (
                    <div
                      ...
                      onClick={() =>
                        (window.location.href = `/narrative/${alert.transactionId}`)
                      }
                    >
                      ...
                      <div className="text-sm text-gray-900 mb-2">
                        {alert.anomalyReasons && alert.anomalyReasons.length > 0
                          ? alert.anomalyReasons[0].description.length > 60
                            ? alert.anomalyReasons[0].description.substring(
                                0,
                                60,
                              ) + "..."
        ...
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <InfoCard title="Client Information">
            <div className="grid grid-cols-2 gap-4">
              ...
              />
              <DataCard label="KYC Status" value={client.kyc_status || "N/A"} />
              <DataCard label="AML Status" value={client.aml_status || "N/A"} />
            </div>
          </InfoCard>
          ...
          <InfoCard title="Limits & Facility">
            <div className="grid grid-cols-2 gap-4">
              ...
              />
              <DataCard label="Risk tier" value={client.risk_tier || "N/A"} />
              <DataCard
