...
async def detect_anomaly(
    ...
    """
    Run anomaly detection on a transaction by hash.
    Uses the same detection flow as CSV-based detection with 6 specialized detectors.
    Results are stored in PostgreSQL/BigQuery and returned in anomaly_results format.
    """
    try:
